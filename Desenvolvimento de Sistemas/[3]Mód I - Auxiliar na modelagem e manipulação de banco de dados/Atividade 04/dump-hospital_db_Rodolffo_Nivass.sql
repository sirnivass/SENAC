...
CREATE TABLE `consulta` (
  ...
  `especialidade_desejada` int(11) DEFAULT NULL,
  `meidco_id` int(11) NOT NULL,
  `pacinete_id` int(11) NOT NULL,
  `convenio_id` int(11) DEFAULT NULL,
  `valor_consulta` double unsigned DEFAULT NULL,
  ...
  KEY `consulta_especialidade_FK_1` (`especialidade_desejada`),
  CONSTRAINT `consulta_convenio_FK` FOREIGN KEY (`convenio_id`) REFERENCES `convenio` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `consulta_especialidade_FK` FOREIGN KEY (`especialidade_desejada`) REFERENCES `especialidade` (`id`),
  CONSTRAINT `consulta_especialidade_FK_1` FOREIGN KEY (`especialidade_desejada`) REFERENCES `especialidade` (`id`),
...
INSERT INTO `consulta` VALUES (1,'2019-02-01 00:00:00',200,2,20,2,NULL,'Paciente Doente, tadinho....','Uns remédio BRABO e injeção na bunda.'),(2,'2019-02-01 09:10:00',170,2,20,2,NULL,'O que o pato disse para a pata?','Vem Quá!'),(3,'2020-01-01 08:56:32',174,1,8,1,359,'A enfermeira ao médico - Tem um homem invisível na sala de espera.','Médico:  - Diga a ele que não posso vê-lo agora.'),(4,'2018-07-17 06:32:00',198,3,3,3,NULL,'Qual é a fórmula da água benta?','R.: H Deus O!'),(5,'2018-07-17 07:32:00',222,4,4,3,NULL,' - Doutor, estou com algum problema. Eu ando esquecendo tudo muito rápido. Um minuto depois, já esqueci.',' - E quando isso começou?, perguntou o médico. - Isso o que, doutor?'),(6,'2020-06-01 12:30:00',224,5,9,4,598,'O condenado à morte esperava a hora da execução, quando chegou o padre: - Meu filho, vim trazer a palavra de Deus para você.','- Perda de tempo, seu padre. Daqui a pouco vou falar com Ele pessoalmente. Algum recado?'),(7,'2021-02-05 07:15:00',220,6,6,5,NULL,'Qual é a cidade brasileira que não tem táxi?','R: Uberlandia'),(8,'2021-02-05 07:18:00',210,7,7,5,NULL,'Um rapaz vai à padaria e pergunta se o salgado era de hoje.- Não, é de ontem. Diz a atendente.','- E como faço para comer o de hoje? - Volte amanhã!'),(9,'2021-02-05 09:18:00',211,8,8,6,NULL,'O que o tijolo falou para o outro?','- Há um \"ciumento\" entre nós...'),(11,'2020-05-05 16:49:00',216,2,3,NULL,2500,'Paciente reclama de dor de CORNO. Fortes dores de cabeça e uma vontade de ligar para o(a) ex.','Evitar músicas como PAGODE e SERTANOJO, não assistir comédias românticas e não ingerir bebidas alcólicas perto de algum tipo de acesso para redes sociais e/ou telefones. Não se humilhe amiga...'),(12,'2020-06-05 16:49:00',217,2,3,NULL,2500,'Paciente da dor de CORNO voltou, não me ouviu e ligou para o bofe. Agora sente-se um lixinho por conseguir ser forte o suficiente e superar o término.','Arrume um ou uma amiga(o)(e) piriguete/putão, você precisa superar, a recomentação agora é putaria, sexo drogas e balada todos os dias. Se assim como eu você nascei na década de 80 e não aguenta mais de 20 min em pé numa festa, vá para um barzinho. Repetir o uso até esquecer o traste.'),(13,'2020-06-05 16:49:00',218,5,6,NULL,2500,'Paciente Com dor de cabeça','01 Chá pela mnha e Um paracetamol 300mg 12h/12h'),(14,'2019-02-01 00:00:00',219,2,20,2,NULL,'Paciente Doente, tadinho....','Uns remédio BRABO e injeção na bunda.'),(15,'2019-02-01 09:10:00',195,2,20,2,NULL,'O que o pato disse para a pata?','Vem Quá!'),(16,'2020-01-01 08:56:32',199,1,10,1,640,'A enfermeira ao médico - Tem um homem invisível na sala de espera.','Médico:  - Diga a ele que não posso vê-lo agora.'),(17,'2018-07-17 06:32:00',191,3,3,3,NULL,'Qual é a fórmula da água benta?','R.: H Deus O!'),(18,'2018-07-17 07:32:00',181,4,4,3,NULL,' - Doutor, estou com algum problema. Eu ando esquecendo tudo muito rápido. Um minuto depois, já esqueci.',' - E quando isso começou?, perguntou o médico. - Isso o que, doutor?'),(19,'2020-06-01 12:30:00',189,5,5,4,2145,'O condenado à morte esperava a hora da execução, quando chegou o padre: - Meu filho, vim trazer a palavra de Deus para você.','- Perda de tempo, seu padre. Daqui a pouco vou falar com Ele pessoalmente. Algum recado?'),(20,'2021-02-05 07:15:00',195,6,6,5,NULL,'Qual é a cidade brasileira que não tem táxi?','R: Uberlandia'),(21,'2021-02-05 07:18:00',205,7,7,5,NULL,'Um rapaz vai à padaria e pergunta se o salgado era de hoje.- Não, é de ontem. Diz a atendente.','- E como faço para comer o de hoje? - Volte amanhã!'),(22,'2021-02-05 09:18:00',200,8,8,6,NULL,'O que o tijolo falou para o outro?','- Há um \"ciumento\" entre nós...'),(23,'2020-05-05 16:49:00',201,2,3,NULL,2500,'Paciente reclama de dor de CORNO. Fortes dores de cabeça e uma vontade de ligar para o(a) ex.','Evitar músicas como PAGODE e SERTANOJO, não assistir comédias românticas e não ingerir bebidas alcólicas perto de algum tipo de acesso para redes sociais e/ou telefones. Não se humilhe amiga...'),(24,'2020-06-05 16:49:00',206,2,3,NULL,2500,'Paciente da dor de CORNO voltou, não me ouviu e ligou para o bofe. Agora sente-se um lixinho por conseguir ser forte o suficiente e superar o término.','Arrume um ou uma amiga(o)(e) piriguete/putão, você precisa superar, a recomentação agora é putaria, sexo drogas e balada todos os dias. Se assim como eu você nascei na década de 80 e não aguenta mais de 20 min em pé numa festa, vá para um barzinho. Repetir o uso até esquecer o traste.'),(25,'2020-06-05 16:49:00',200,5,6,NULL,2500,'Paciente Com dor de cabeça','01 Chá pela mnha e Um paracetamol 300mg 12h/12h'),(26,'2020-06-01 12:30:00',197,3,4,2,500,'O condenado à morte esperava a hora da execução, quando chegou o padre: - Meu filho, vim trazer a palavra de Deus para você.','- Perda de tempo, seu padre. Daqui a pouco vou falar com Ele pessoalmente. Algum recado?'),(27,'2020-06-01 12:30:00',207,2,6,2,200,'O condenado à morte esperava a hora da execução, quando chegou o padre: - Meu filho, vim trazer a palavra de Deus para você.','- Perda de tempo, seu padre. Daqui a pouco vou falar com Ele pessoalmente. Algum recado?'),(28,'2020-06-01 12:30:00',209,6,7,3,600,'O condenado à morte esperava a hora da execução, quando chegou o padre: - Meu filho, vim trazer a palavra de Deus para você.','- Perda de tempo, seu padre. Daqui a pouco vou falar com Ele pessoalmente. Algum recado?');
...
INSERT INTO `enfermeiro` VALUES (1,3471,43),(2,9102,38),(3,6666,32),(4,7248,37),(5,3297,40),(6,1977,39),(7,6225,41),(8,6291,39),(9,7289,40),(10,5890,46),(11,3547,41),(12,2365,47),(13,7023,34),(14,9637,30),(15,5337,31),(16,2451,37),(17,6400,43),(18,5015,40),(19,2566,36),(20,8978,42),(21,4673,33),(22,6944,40),(23,9460,44),(24,9047,32),(25,2645,43),(27,7526,30),(28,2329,39),(29,2094,38),(30,7570,41),(31,8584,36),(32,5568,34),(33,7734,43),(34,3106,39),(35,8927,45),(37,9026,48),(38,9221,34),(39,6942,37),(40,4447,32),(41,4100,37),(44,3914,31),(45,5038,30),(46,7402,33),(47,7146,37),(48,3209,40),(49,6503,37),(50,4995,41);
...
INSERT INTO `especialidade` VALUES (1,'Clínica Geral'),(170,'Acupuntura'),(171,'Alergia e Imunologia'),(172,'Anestesiologia'),(173,'Angiologia'),(174,'Cardiologia'),(175,'Cirurgia Cardiovascular'),(176,'Cirurgia da Mão'),(177,'Cirurgia de Cabeça e Pescoço'),(178,'Cirurgia do Aparelho Digestivo'),(179,'Cirurgia Geral'),(180,'Cirurgia Oncológica'),(181,'Cirurgia Pediátrica'),(182,'Cirurgia Plástica'),(183,'Cirurgia Torácica'),(184,'Cirurgia Vascular'),(186,'Coloproctologia'),(187,'Dermatologia'),(188,'Endocrinologia e Metabologia'),(189,'Endoscopia'),(190,'Gastroenterologia'),(191,'Genética Médica'),(192,'Geriatria'),(193,'Ginecologia e Obstetrícia'),(194,'Hematologia e Hemoterapia'),(195,'Homeopatia'),(196,'Infectologia'),(197,'Mastologia'),(198,'Medicina de Emergência'),(199,'Medicina de Família e Comunidade'),(200,'Medicina do Trabalho'),(201,'Medicina de Tráfego'),(202,'Medicina Esportiva'),(203,'Medicina Física e Reabilitação'),(204,'Medicina Intensiva'),(205,'Medicina Legal e Perícia Médica'),(206,'Medicina Nuclear'),(207,'Medicina Preventiva e Social'),(208,'Nefrologia'),(209,'Neurocirurgia'),(210,'Neurologia'),(211,'Nutrologia'),(212,'Oftalmologia'),(213,'Oncologia Clínica'),(214,'Ortopedia e Traumatologia'),(215,'Otorrinolaringologia'),(216,'Patologia'),(217,'Patologia Clínica/ Medicina Laboratorial'),(218,'Pediatria'),(219,'Pneumologia'),(220,'Psiquiatria'),(221,'Radiologia e Diagnóstico por Imagem'),(222,'Radioterapia'),(223,'Reumatologia'),(224,'Urologia'),(225,'Clínica Médica');
...
INSERT INTO `especialidade_medico` VALUES (1,1,200),(2,2,201),(3,3,202),(4,4,203),(5,5,200),(6,6,199),(7,7,198),(8,8,189),(9,9,190),(10,10,171),(11,11,175),(12,12,202),(13,13,225),(14,14,175),(15,15,180),(16,16,1),(17,17,188),(18,18,177),(19,19,200),(20,20,210),(21,21,212),(22,22,222),(23,23,192),(24,24,193),(25,25,195),(26,26,196),(27,27,194),(28,28,197),(29,29,180),(30,30,181),(31,31,182),(32,32,183),(33,33,187),(34,34,189),(35,35,179),(36,36,178),(37,37,175),(38,38,174),(39,39,172),(40,1,170),(41,2,195),(42,3,189),(43,4,200),(44,5,201),(45,6,206),(46,7,221),(47,8,222),(48,9,223),(49,10,220),(50,11,219),(51,12,218),(52,13,217),(53,14,214),(54,15,213),(55,16,212),(56,17,211),(57,18,210),(58,19,199),(59,20,198),(60,21,177),(61,22,172),(62,23,171),(63,24,175),(64,25,178),(65,26,180),(66,27,181),(67,28,182),(68,29,183),(69,30,184),(70,31,188),(71,32,1),(72,33,200),(73,34,221),(74,35,202),(75,36,220),(76,37,199),(77,38,188),(78,39,187);
...
INSERT INTO `internacao` VALUES (1,'2017-11-28','2017-11-29','2017-11-29','Lavagem gástrica',1,10,2,5),(2,'2018-11-28','2018-09-12','2018-11-30','Remoção de molusco contagioso',2,10,3,1),(3,'2019-01-02','2019-01-15','2019-01-15',' Tratamento de unha encravada',1,5,1,4),(4,'2019-02-04','2019-02-06','2019-02-07','Lipoma',3,4,4,3),(5,'2019-04-12','2019-04-14','2019-04-14','Remoção de molusco contagioso',4,3,5,2),(6,'2020-04-20','2020-04-25','2020-04-22','Exérese de cistos, lipomas e nevos',6,7,8,6),(7,'2020-02-12','2020-02-25','2020-02-25','Exérese de cistos, lipomas e nevos',9,3,11,12),(8,'2020-06-15','2020-02-25','2020-02-25','Exérese de cistos, lipomas e nevos',9,9,13,11),(9,'2020-12-30','2020-02-25','2020-02-25','Exérese de cistos, lipomas e nevos',9,12,12,13),(10,'2020-06-15','2020-02-25','2020-02-25','Exérese de cistos, lipomas e nevos',9,7,4,14),(11,'2017-11-28','2017-11-29','2017-11-29','Lavagem gástrica',1,10,2,5),(12,'2018-11-28','2018-09-12','2018-11-30','Remoção de molusco contagioso',2,10,3,1),(13,'2019-01-02','2019-01-15','2019-01-15',' Tratamento de unha encravada',1,5,1,4),(14,'2019-02-04','2019-02-06','2019-02-07','Lipoma',3,4,4,3),(15,'2019-04-12','2019-04-14','2019-04-14','Remoção de molusco contagioso',4,3,5,2),(16,'2020-04-20','2020-04-25','2020-04-22','Exérese de cistos, lipomas e nevos',6,7,8,6);
...
INSERT INTO `internacao_enfermeiro` VALUES (1,1,1),(2,1,2),(3,2,3),(4,3,4),(5,4,5),(6,5,6),(7,6,7),(8,7,8),(9,8,9),(10,9,10),(11,9,11);
...
CREATE TABLE `medico` (
  ...
  `pessoa_id` int(11) DEFAULT NULL,
  `em_atividade` bit(1) NOT NULL DEFAULT b'1',
  PRIMARY KEY (`id`),
...
INSERT INTO `paciente` VALUES (3,100,2),(4,69,5),(5,98,4),(6,80,13),(7,76,10),(8,69,7),(9,64,9),(10,74,20),(11,68,15),(12,70,2),(13,67,17),(14,68,4),(15,99,14),(16,53,11),(17,56,5),(18,97,6),(19,96,19),(20,78,17),(21,67,1),(22,91,16),(23,61,5),(24,96,13),(25,57,14),(26,57,10),(27,87,16),(28,68,3),(29,74,11),(30,60,19),(31,52,15),(32,53,19),(33,58,9),(34,83,9),(35,97,20),(36,97,10),(37,97,11),(38,78,14),(39,71,4),(40,62,19),(41,56,18),(42,90,14),(43,64,13),(44,73,8),(45,92,14),(46,54,2),(47,54,12),(48,85,17),(49,94,10),(50,59,18),(51,83,18),(52,80,7),(53,55,9);
