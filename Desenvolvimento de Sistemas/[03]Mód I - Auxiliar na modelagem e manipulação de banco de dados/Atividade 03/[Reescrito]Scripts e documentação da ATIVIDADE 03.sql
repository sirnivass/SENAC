...
CREATE TABLE `convenio` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci; -- AUTO_INCREMENT=21 mostra onde a o "id" parou.... logo ele continuará a partir daqui.
...
ALTER TABLE Atividade_03.medico ADD `atividade` bit(1) NOT NULL DEFAULT b'1'; -- no povoamento estão os registros "1" e "0"
-- 
...
(1,'15945','DF',1,1),(2,'69854','DF',28,1),(3,'15945','DF',1,1),(4,'35222','GO',20,1),
(5,'46548','GO',8,1),(6,'19374','RJ',17,1),(7,'18146','PE',23,1),(8,'32322','RJ',12,1),
(9,'64773','RJ',20,1),(10,'23896','PA',26,1),(11,'77907','SC',25,1),(12,'42132','CE',16,1),
(13,'61823','MA',13,1),(14,'35634','PA',22,0),(15,'60678','PE',15,1),(16,'57925','PR',14,0),
(17,'67448','SC',16,1),(18,'55425','PB',17,1),(19,'62114','PB',18,1),(20,'04646','PE',9,1),
(21,'81877','CE',19,1),(22,'54542','PB',11,1),(23,'42855','PB',3,1),(24,'30496','PA',10,0),
(25,'91435','MG',27,1),(26,'77447','PE',21,1),(27,'28727','RS',24,1),(28,'24074','CE',6,1),
(29,'79232','RS',9,1),(30,'04467','GO',7,0),(31,'16739','PE',2,1),(32,'12396','RS',3,1),
(33,'55617','BA',4,1),(34,'42890','SC',5,1),(35,'47730','PR',5,1),(36,'74364','RS',29,1),
(37,'85544','CE',9,1),(38,'42989','SP',3,1),(39,'15945','DF',1,1);
UNLOCK TABLES;
--
--
...
INSERT INTO `paciente` (`pessoa_id`, `convenio_id`) VALUES 
(100,2),(69,5),(98,4),(10,13),(76,10),(69,7),(64,9),(74,20),(68,15),(70,2),
(67,17),(68,4),(99,14),(53,11),(56,5),(97,6),(96,19),(78,17),(67,1),(91,16),
(61,5),(96,13),(57,14),(57,10),(87,16),(68,3),(74,11),(60,19),(52,15),(53,19),
(58,9),(83,9),(97,20),(97,10),(97,11),(78,14),(71,4),(62,19),(56,18),(90,14),
(64,13),(73,8),(92,14),(54,2),(54,12),(85,17),(94,10),(59,18),(83,18),(80,7),(55,9);
UNLOCK TABLES;


INSERT INTO `internacao` (`data_entrada`, `alta_prevista`, `alta`, `procedimentos`, `id_medicos`, `id_pacientes`, `id_enfermeiros`, `id_quartos`) VALUES 
('2017-11-28','2017-11-29','2017-11-28','Lavagem gástrica',1,10,2,5),
('2018-11-28','2018-09-12','2018-11-27','Remoção de molusco contagioso',1,10,3,1),
('2019-01-02','2019-01-15','2019-01-15',' Tratamento de unha encravada',1,5,1,4),
('2019-02-04','2019-02-06','2019-02-07','Lipoma',3,4,4,3),
('2019-04-12','2019-04-14','2019-04-14','Remoção de molusco contagioso',4,3,5,2),
('2020-04-20','2020-04-25','2020-04-22','Exérese de cistos, lipomas e nevos',6,7,8,6),
('2020-02-12','2020-02-25','2020-02-25','Exérese de cistos, lipomas e nevos',9,7,4,7),
('2020-02-12','2020-02-25','2020-02-25','Exérese de cistos, lipomas e nevos',9,7,4,11),
('2020-02-12','2020-02-25','2020-02-25','Exérese de cistos, lipomas e nevos',9,7,4,13);
...
UPDATE Atividade_03.internacao i
INNER JOIN hospital_db_Rodolffo_Nivass.quarto q ON i.id_quartos  = q.id
...
UPDATE Atividade_03.paciente -- após ver quais são os pacientes, mudando os convenios
SET convenio_id=1
WHERE id IN (8, 33);
...
-- Para adicionar novamente eu deveria mudar o paciente com acesso ao 
ALTER TABLE Atividade_03.paciente ADD CONSTRAINT paciente_convenio_FK FOREIGN KEY (convenio_id) REFERENCES Atividade_03.convenio(id);
...
/* VOU DEIXAR COMENTADO PARA NAO ATRAPALHAR.
